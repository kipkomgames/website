...
(function($) {
	"use strict";
		...
		$('#clock-countdown').countdown('2017/3/15 12:00:00').on('update.countdown', function(event) {
			var $this = $(this).html(event.strftime(''
				+ '<div class="counter-container"><div class="counter-box first"><div class="number">%-D</div><span>ימים</span></div>'
				+ '<div class="counter-box"><div class="number">%H</div><span>שעות</span></div>'
				+ '<div class="counter-box"><div class="number">%M</div><span>דקות</span></div>'
				+ '<div class="counter-box last"><div class="number">%S</div><span>שניות</span></div></div>'
			));
		});
