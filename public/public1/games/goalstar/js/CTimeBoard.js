function CTimeBoard(oSprite, iX, iY) {
    ...
    this._init = function (oSprite, iX, iY) {
        ...
        _oTimeTextStroke = new createjs.Text(TEXT_TIME + ": 0", "28px " + FONT_GAME, "#000000");
        ...
        _oTimeTextStroke.outline = 5;
        _oContainer.addChild(_oTimeTextStroke);

        _oTimeText = new createjs.Text(TEXT_TIME + ": 0", "28px " + FONT_GAME, TEXT_COLOR);
